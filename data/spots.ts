 ...
 * 公式サイトを開けるようにしています。最終見直し: 2026-07-29。
 */
export const spots: Spot[] = [
  ...
  },
  {
    ...
    officialUrl: "https://www.hakone-garasunomori.jp/entrance/", openingHours: "10:00〜17:30（入館は17:00まで）", closedDays: "2026/7/18〜2027/1/11の企画展会期中は無休（天候・交通による変更あり）", priceAdult: "1,800円", priceJuniorHigh: "小中学生600円", priceElementary: "小中学生600円", stayMinutes: 100,
    parkingAvailable: true, parkingSpaces: "隣接有料150台・第三駐車場無料", rainyDayFriendly: true, walkingLevel: 2, childFriendly: 4, juniorHighFriendly: 4,
    crowdLevel: 3, crowdSource: "general", crowdUpdatedAt: "2026-07-29", crowdHint: "11〜14時は入館・レストランが混みやすい", bestTime: "14時以降", tags: ["子ども向け", "雨天対応", "駐車場あり", "飲食店あり", "トイレあり"], dataNote: "2026年8月12日・13日の開館時間、企画展会期中無休、料金、駐車場を公式案内で確認。天候・交通による変更は直前に再確認してください。", photoKind: "placeholder", tripOpenDays: [1, 2], factCheckedAt: "2026-07-29"
  },
  {
    ...
    officialUrl: "https://www.lalique-museum.com/", openingHours: "9:00〜16:00（美術館入館は15:30まで）", closedDays: "2026年の休館は1/13〜1/23（営業変更は要確認）", priceAdult: "1,500円", priceJuniorHigh: "中学生・小学生800円", priceElementary: "中学生・小学生800円", stayMinutes: 75,
    parkingAvailable: true, parkingSpaces: "あり（公式案内を確認）", rainyDayFriendly: true, walkingLevel: 1, childFriendly: 3, juniorHighFriendly: 4,
    crowdLevel: 2, crowdSource: "general", crowdUpdatedAt: "2026-07-29", crowdHint: "昼前後はカフェ利用が集中しやすい", bestTime: "開館直後または14時以降", tags: ["雨天対応", "駐車場あり", "飲食店あり", "トイレあり"], dataNote: "2026年8月12日・13日の開館見込み、開館時間、料金を2026年企画展の公式案内で確認。営業変更は直前に再確認してください。", photoKind: "placeholder", tripOpenDays: [1, 2], factCheckedAt: "2026-07-29"
  },
  {
    ...
    officialUrl: "https://hakone-shisseikaen.com/", openingHours: "9:00〜17:00（最終入園16:30）", closedDays: "3/14〜11/30は期間中無休", priceAdult: "700円", priceJuniorHigh: "個人料金は公式サイトで要確認", priceElementary: "400円", stayMinutes: 70,
    parkingAvailable: true, parkingSpaces: "無料90台（第1・第2駐車場）", rainyDayFriendly: false, walkingLevel: 3, childFriendly: 4, juniorHighFriendly: 4,
    crowdLevel: 2, crowdSource: "general", crowdUpdatedAt: "2026-07-29", crowdHint: "連休・午前中に団体客が入りやすい", bestTime: "開園直後", tags: ["子ども向け", "駐車場あり", "トイレあり", "宿から近い"], dataNote: "2026年の開園期間、期間中無休、入園時間、個人大人・小学生料金、駐車台数を公式案内で確認。雨天時は木道の足元を確認してください。", photoKind: "placeholder", tripOpenDays: [1, 2], factCheckedAt: "2026-07-29"
  },
  {
  ...
  },
  {
    ...
    officialUrl: "https://www.polamuseum.or.jp/info/", openingHours: "9:00〜17:00（入館は16:30まで）", closedDays: "2026年は6/1〜16・12/1が全館休館", priceAdult: "2,200円", priceJuniorHigh: "中学生以下無料", priceElementary: "中学生以下無料", stayMinutes: 110,
    ...
    crowdLevel: 3, crowdSource: "general", crowdUpdatedAt: "2026-07-29", crowdHint: "11〜14時・企画展の会期末は混みやすい", bestTime: "9時台または14時半以降", tags: ["雨天対応", "駐車場あり", "飲食店あり", "トイレあり", "宿から近い"], dataNote: "2026年の休館日、開館時間、料金を公式案内で確認。小中学生は年齢確認書類が必要です。", photoKind: "placeholder", tripOpenDays: [1, 2], factCheckedAt: "2026-07-29"
  },
  {
  ...
  },
  {
    ...
    officialUrl: "https://www.hakone-oam.or.jp/info/", openingHours: "9:00〜17:00（入館は16:30まで）", closedDays: "年中無休", priceAdult: "2,000円（WEB 1,800円）", priceJuniorHigh: "中学生・小学生800円（WEB 600円）", priceElementary: "中学生・小学生800円（WEB 600円）", stayMinutes: 120,
    parkingAvailable: true, parkingSpaces: "一般車3時間まで500円（台数は公式未掲載）", rainyDayFriendly: true, walkingLevel: 4, childFriendly: 5, juniorHighFriendly: 5,
    crowdLevel: 3, crowdSource: "general", crowdUpdatedAt: "2026-07-29", crowdHint: "10〜14時は入館・屋外エリアが混みやすい", bestTime: "開館直後", tags: ["子ども向け", "雨天対応", "駐車場あり", "飲食店あり", "トイレあり"], dataNote: "開館時間、年中無休、窓口・WEB料金、駐車料金を公式案内で確認。駐車台数は公式ページで確認できないため推測値を削除しました。", photoKind: "placeholder", tripOpenDays: [1, 2], factCheckedAt: "2026-07-29"
  },
  {
  ...
  },
  {
    ...
    officialUrl: "https://moaart.or.jp/hakone/topinfo/20260119/", openingHours: "2026/5/7〜10/29は改修工事のため全面休館", closedDays: "2026/5/7〜10/29全面休館・通常は木曜ほか", priceAdult: "通常1,430円（休館中）", priceJuniorHigh: "通常は中学生以下無料（休館中）", priceElementary: "通常は中学生以下無料（休館中）", stayMinutes: 75,
    parkingAvailable: true, parkingSpaces: "無料（台数は公式未掲載）", rainyDayFriendly: true, walkingLevel: 3, childFriendly: 2, juniorHighFriendly: 4,
    crowdLevel: 2, crowdSource: "general", crowdUpdatedAt: "2026-07-29", crowdHint: "旅行日は全面休館のため訪問不可", bestTime: "2026年10月30日以降の再開予定を公式確認", tags: ["雨天対応", "駐車場あり", "トイレあり"], dataNote: "公式の改修工事案内で2026年5月7日〜10月29日の全面休館を確認。8月12日・13日とも候補外です。", photoKind: "placeholder", tripOpenDays: [], factCheckedAt: "2026-07-29"
  },
  {
    ...
    crowdLevel: 3, crowdSource: "general", crowdUpdatedAt: "2026-07-26", crowdHint: "土日祝の11〜13時は駅前・店内とも混みやすい", bestTime: "11時台前半または13時半以降", tags: ["飲食店あり", "駐車場あり", "雨天対応", "トイレあり"], dataNote: "駐車サービス・営業時間は2026-07-26に公式／店舗情報で確認。外部口コミ評価は変動するため、固定点数は表示しません。", photoKind: "placeholder", reviewScore: "最新の評価・営業状況は公式サイトで確認"
  },
  {
  ...
  },
  {
    ...
    crowdLevel: 2, crowdSource: "general", crowdUpdatedAt: "2026-07-26", crowdHint: "休日の12時台は予約・宿泊利用と重なりやすい", bestTime: "11時台または13時半以降", tags: ["飲食店あり", "駐車場あり", "雨天対応", "宿から近い"], dataNote: "営業日・料金・駐車条件は2026-07-26に公式情報を確認。口コミ評価は変動するため固定点数は表示しません。", photoKind: "placeholder", reviewScore: "最新の評価・営業状況は公式サイトで確認"
  },
  {
  ...
  },
  {
    ...
    crowdLevel: 3, crowdSource: "general", crowdUpdatedAt: "2026-07-26", crowdHint: "昼どき・箱根湯本を通過する時間帯は待ちが出やすい", bestTime: "11時台または14時以降", tags: ["飲食店あり", "駐車場あり", "雨天対応"], dataNote: "水曜休業のため8月12日は候補外です。8月13日の営業状況も直前に公式サイトで再確認してください。", photoKind: "placeholder", reviewScore: "最新の評価・営業状況は公式サイトで確認", tripOpenDays: [2]
  },
  {
    ...
    crowdLevel: 3, crowdSource: "general", crowdUpdatedAt: "2026-07-26", crowdHint: "箱根湯本の昼食・夕食時間帯は混みやすい", bestTime: "11時半の開店直後または16時半以降", tags: ["飲食店あり", "駐車場あり", "雨天対応", "子ども向け"], dataNote: "営業時間・提携駐車場の利用条件は2026-07-26に公式／店舗案内を確認。運転者の飲酒はできません。", photoKind: "placeholder", reviewScore: "最新の評価・営業状況は公式サイトで確認"
  },
  {
    ...
    crowdLevel: 4, crowdSource: "general", crowdUpdatedAt: "2026-07-26", crowdHint: "有名店のため、休日・昼どきは待ち時間が出やすい", bestTime: "開店直後または14時前", tags: ["飲食店あり", "駐車場あり", "雨天対応", "子ども向け"], dataNote: "水曜休業のため8月12日は候補外です。8月13日は混雑と待ち時間を見込み、営業状況を公式サイトで再確認してください。", photoKind: "placeholder", reviewScore: "最新の評価・営業状況は公式サイトで確認", tripOpenDays: [2]
  },
  {
  ...
  },
  {
    ...
    crowdLevel: 2, crowdSource: "general", crowdUpdatedAt: "2026-07-26", crowdHint: "昼食・夕食の開始時間帯は予約利用と重なりやすい", bestTime: "11時半の開店直後または13時半以降", tags: ["飲食店あり", "駐車場あり", "雨天対応", "宿から近い", "子ども向け"], dataNote: "水曜休業のため8月12日は候補外です。8月13日の営業状況も直前に公式サイトで再確認してください。", photoKind: "placeholder", reviewScore: "最新の評価・営業状況は公式サイトで確認", tripOpenDays: [2]
  },
  {
    ...
    crowdLevel: 2, crowdSource: "general", crowdUpdatedAt: "2026-07-26", crowdHint: "昼どきは登山・ドライブ客で混みやすい", bestTime: "10時半の開店直後または14時以降", tags: ["飲食店あり", "駐車場あり", "雨天対応", "子ども向け", "滞在1時間以内"], dataNote: "水曜休業のため8月12日は候補外です。8月13日の営業状況も直前に公式サイトで再確認してください。", photoKind: "placeholder", reviewScore: "最新の評価・営業状況は公式サイトで確認", tripOpenDays: [2]
  },
  {
  ...
  },
  {
    ...
    officialUrl: "https://www.princehotels.co.jp/amuse/hakone-en/ropeway/", openingHours: "始発9:00、上り最終16:30・下り最終16:50（季節・天候で変更）", closedDays: "定休日なし（点検・強風・雷などで運休あり）", priceAdult: "往復2,200円", priceJuniorHigh: "中学生往復2,200円", priceElementary: "小学生往復1,100円", stayMinutes: 90,
    ...
    crowdLevel: 4, crowdSource: "forecast", crowdUpdatedAt: "2026-07-29", crowdHint: "お盆は箱根園入口・乗車列とも混みやすく、天候で待ち時間が変動", bestTime: "9時の始発付近", tags: ["絶景", "子ども向け", "駐車場あり", "トイレあり", "飲食店あり"], dataNote: "運行時間・往復運賃を公式案内で確認。天候による運休があるため当日朝に運行状況を確認してください。", photoKind: "placeholder", tripOpenDays: [1, 2], factCheckedAt: "2026-07-29"
  },
  {
  ...
  },
  {
    ...
    crowdLevel: 3, crowdSource: "forecast", crowdUpdatedAt: "2026-07-29", crowdHint: "お盆の日中は箱根町港・関所周辺の道路と駐車場が混みやすい", bestTime: "8〜10時または15時以降", tags: ["自然", "絶景", "無料", "駐車場あり", "トイレあり"], dataNote: "入園自由・無料、湖畔展望館の休館日、普通車62台・利用時間7:00〜21:00を県立公園公式案内で確認。坂と階段があります。", photoKind: "placeholder", tripOpenDays: [1, 2], factCheckedAt: "2026-07-29"
  },
  {
